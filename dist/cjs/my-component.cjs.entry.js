...
const index = require('./index-ab6b71ed.js');
...
const MyComponent = class {
    ...
    render() {
        return (index.h("div", { key: '882bfb502d74ccbdb9210a14ad2d14e76c6a970a', class: "chat-container" }, index.h("div", { key: '85f37fb53ff5a404cae16904bdbe0c2d2c190b36', class: "chat-header" }, "Timmy AI"), index.h("div", { key: '3da51ea1b898ebbaaefbe27dd2fbf3172e200395', class: "chat-messages" }, this.isLoading ? (index.h("div", { class: "loading" }, "Loading messages...")) : this.errorMessage ? (index.h("div", { class: "error" }, this.errorMessage)) : (this.chatMessages.map((msg, index$1) => {
            if (msg.type === 'text') {
                return (index.h("div", { class: `chat-message ${msg.isAIReply ? 'ai' : 'user'}`, key: index$1 }, msg.content));
            }
            else if (msg.type === 'card') {
                return (index.h("div", { class: "chat-card", key: index$1 }, index.h("h4", null, msg.content.title), " ", index.h("img", { src: msg.content.imageUrl, alt: msg.content.title }), index.h("a", { href: msg.content.productUrl, target: "_blank", rel: "noopener noreferrer" }, "View Product")));
            }
            else if (msg.type === 'image') {
                return (index.h("div", { class: "chat-message", key: index$1 }, index.h("img", { src: msg.content, alt: "Image message" })));
            }
