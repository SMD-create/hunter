...
const MyComponent = class {
    ...
    render() {
        return (h("div", { key: 'c1564d063089dca98aa57d999f78be9056ba406b', class: "chat-container" }, h("div", { key: '72c7244b5442726fdfe0872e1b162c91ce04a8aa', class: "chat-header" }, "Timmy AI"), h("div", { key: 'e2e3956d16f764ecf08d9a72c8d9cfd23125b542', class: "chat-messages" }, this.isLoading ? (h("div", { class: "loading" }, "Loading messages...")) : this.errorMessage ? (h("div", { class: "error" }, this.errorMessage)) : (this.renderChatMessages()))));
    }
