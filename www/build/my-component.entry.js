...
const MyComponent = class {
    ...
    render() {
        return (h("div", { key: '2b2298cc21cc9dcd45650bd7e2e534dc976284ef', class: "chat-container" }, h("div", { key: '1890263f805f4d4121c1fe747a37a77de8e88a97', class: "chat-header" }, "Timmy AI"), h("div", { key: '33f506f75bab9a0b615e0ed66959a9c9ecb05492', class: "chat-messages" }, this.isLoading ? (h("div", { class: "loading" }, "Loading messages...")) : this.errorMessage ? (h("div", { class: "error" }, this.errorMessage)) : (this.renderChatMessages()))));
    }
};
